...
class TestOpenReleasePullRequestInput:
    def test_when_created_with_required_fields_then_stores_values(self) -> None:
...
class TestOpenReleasePullRequestOutput:
    def test_when_created_with_values_then_stores_all(self) -> None:
    ...
    def test_when_created_with_none_values_then_stores_none(self) -> None:
    ...
    def test_equality_when_different_then_not_equal(self) -> None:
        o1 = OpenReleasePullRequestOutput(pr_id="1", url="http://example.com")
