...
class TestPrepareReleaseInput:
    def test_when_created_with_level_then_stores_value(self) -> None:
    ...
    def test_when_major_level_then_stored(self) -> None:
...
class TestPrepareReleaseOutput:
    def test_when_created_with_all_fields_then_stores_all(self) -> None:
    ...
    def test_when_changelog_entries_default_then_empty_list(self) -> None:
        output = PrepareReleaseOutput(
            version="1.0.0",
    ...
    def test_equality_when_different_changelog_then_not_equal(self) -> None:
        o1 = PrepareReleaseOutput(
            version="1.0.0",
            branch="release/v1.0.0",
            tag="v1.0.0",
